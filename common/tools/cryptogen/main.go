...
var (
	...
	gmGenFlag    = gen.Flag("gm", "enable gm cryptographic").Default("true").Bool()
	...
	gmExtFlag    = ext.Flag("gm", "enable gm cryptographic").Default("true").Bool()
)
...
func generateNodes(baseDir string, nodes []NodeSpec, signCA *ca.CA, tlsCA *ca.CA, nodeType int, nodeOUs, useGm bool) {
